...
const SVG_QODER = '<svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><title>Qoder</title><circle cx="12" cy="12" r="10"/><polyline points="8,12 11,15 16,9"/></svg>';
